...
class NewUiTokenAutoCompleteField extends React.Component {
  constructor() {
    super();
  ...
  render() {
    return (
      <div className="d-flex align-items-center navigation-autocomplete-token">
        <div className="d-flex flex-row align-items-center col-12">{this._renderInputForm()}</div>
        <ul
 ...
 */
NewUiTokenAutoCompleteField.propTypes = {
  onTokenSelected: PropTypes.func.isRequired,
};

export default connect(mapStateToProps)(NewUiTokenAutoCompleteField);
