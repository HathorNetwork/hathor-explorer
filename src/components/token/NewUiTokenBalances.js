...
import NewUiTokenBalancesTable from './NewUiTokenBalancesTable';
import NewUiTokenAutoCompleteField from './NewUiTokenAutoCompleteField';

/**
 * Displays custom tokens in a table with pagination buttons and a search bar.
 */
class NewUiTokenBalances extends React.Component {
  /**
  ...
  render() {
    ...
    const renderSearchField = () => {
      return (
        <NewUiTokenAutoCompleteField
          onTokenSelected={this.onTokenSelected.bind(this)}
 ...
 */
NewUiTokenBalances.propTypes = {
  maintenanceMode: PropTypes.bool.isRequired,
};

export default withRouter(NewUiTokenBalances);
