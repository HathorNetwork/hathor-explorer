  ...
  render() {
    ...
    return (
      <tr>
        ...
        <td className="d-lg-table-cell pr-3">{numberUtils.prettyValue(this.props.feature.start_height, 0)}</td>
        <td className="d-lg-table-cell pr-3">{numberUtils.prettyValue(this.props.feature.minimum_activation_height, 0)}</td>
        <td className="d-lg-table-cell pr-3">{numberUtils.prettyValue(this.props.feature.timeout_height, 0)}</td>
