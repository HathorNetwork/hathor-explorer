...
export const BASE_URL = process.env.REACT_APP_BASE_URL || "https://node1.charlie.testnet.hathor.network/v1a/";

let tmp_ws_url = process.env.REACT_APP_WS_URL || "wss://node1.charlie.testnet.hathor.network/v1a/ws/";
...
export const MIN_API_VERSION = '0.28.0-beta';
